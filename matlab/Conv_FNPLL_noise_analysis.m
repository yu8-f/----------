%% Noise analysis of Conventional Single Loop FNPLL
...
figure (1);
semilogx(f, S_N_IN_dB, f, S_N_DSM_dB, f, S_N_VCO_dB, f, S_N_TOT_dB, f, S_N_VCO_free_dB, f, S_N_INT_dB, 'LineWidth', 2);
set(gca, 'FontName', 'Arial', 'fontsize', 12, 'fontweight', 'b');
axis ([10e3 100e6 -250 -80]);
grid on;
legend ('Input referred white noise', 'DSM', 'VCO', 'Total', 'VCO freerun', 'Integer-N');
